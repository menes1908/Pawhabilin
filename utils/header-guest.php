...
<header class="sticky top-0 z-50 border-b bg-white/80 backdrop-blur-sm">
  <div class="mx-auto px-4 w-full max-w-7xl">
    <div class="flex h-16 items-center justify-between">
      ...
      <nav class="hidden md:flex items-center space-x-8">
        <a href="<?= htmlspecialchars($asset('index')) ?>" class="text-gray-500 hover:text-gray-900 transition-colors">About</a>

        <a href="<?= htmlspecialchars($asset('become-sitter')) ?>" class="text-gray-500 hover:text-gray-900 transition-colors">Become a Sitter</a>

        <a href="<?= htmlspecialchars($asset('shops')) ?>" class="text-gray-500 hover:text-gray-900 transition-colors">Shop</a>
  ...
  <a href="<?= htmlspecialchars($asset('subscriptions')) ?>" class="text-gray-500 hover:text-gray-900 transition-colors">Subscription</a>
      ...
      <div class="flex items-center gap-3">
        ...
        <a href="<?= htmlspecialchars($asset('login')) ?>" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 hover:bg-orange-50 h-10 px-4 py-2">
          Log In
        </a>
        <a href="<?= htmlspecialchars($asset('registration')) ?>" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 h-10 px-4 py-2 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white">
          Sign Up
        </a>
      </div>
    </div>
