<?php
// Logged-in (non-admin) access denied page. Guests should not reach this; send them to guest error.
session_start();
if (empty($_SESSION['users_id'])) {
    header('Location: ../../error.php');
    exit;
}
// Always send user back to their dashboard
$redirectTarget = 'index.php'; // relative to views/users/
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="p-12 text-center">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-sm text-gray-500 mt-4">
                        Head back to your user dashboard 🐾
                    </p>
                </div>
